...
<head>
    ...
    <title>San Jos&eacute; del Carmen| Avisos</title>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="courses-page-top-area">
                                    <div class="courses-page-top-left">
                                        <p>Mostrar 13-24 of 50 resultados</p>
                                    </div>
                                   ...
                                   <!--  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="courses-box3">
                                            <div class="single-item-wrapper">
                                                ...
                                                <div class="courses-content-wrapper">
                                                    <h3 class="item-title"><a href="single-news.html">GMAT</a></h3>
                                                    ...
                                                    <div class="courses-fee">01/10/2018</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="courses-box3">
                                            <div class="single-item-wrapper">
                                                ...
                                                <div class="courses-content-wrapper">
                                                    ...
                                                    <div class="courses-fee">01/11/2018</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="courses-box3">
                                            <div class="single-item-wrapper">
                                                ...
                                                <div class="courses-content-wrapper">
                                                    ...
                                                    <div class="courses-fee">02/11/2018</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="sidebar">
                            <div class="sidebar-box">
                                <div class="sidebar-box-inner">
                                    <h3 class="sidebar-title">Buscar Avisos</h3>
                                    <div class="sidebar-find-course">
                                        <form id="checkout-form">
                                            <div class="form-group course-name">
                                                <input id="first-name" placeholder="Tema de Aviso" class="form-control" type="text" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <button class="sidebar-search-btn disabled" type="submit" value="Login">Buscar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="sidebar-box">
                                <div class="sidebar-box-inner">
                                    <h3 class="sidebar-title">Categor&iacute;a de Aviso</h3>
                                    <ul class="sidebar-categories">
                                        <li><a href="#">Generales</a></li>
                                        <li><a href="#">Pre-B&aacute;sica</a></li>
                                        <li><a href="#">B&aacute;sica</a></li>
                                    ...
                                    <h3 class="sidebar-title">Buscar por fecha</h3>
                                     <form id="checkout-form">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-select">
                                                    <select id="district" class='select2'>
                                                        <option value="0">Enero 2018</option>
                                                        <option value="1">Febrero 2018</option>
                                                        <option value="2">Marzo 2018</option>
                                                        <option value="4">Abil 2018</option>
                                                        <option value="4">Mayo 2018</option>
                                                        <option value="4">Junio 2018</option>
                                                        <option value="4">Julio 2018</option>
                                                        <option value="4">Agosto 2018</option>
                                                        <option value="4">Septiembre 2018</option>
                                                        <option value="4">Octubre 2018</option>
                                                        <option value="4">Noviembre 2018</option>
                                                        <option value="4">Diciembre 2018</option>
