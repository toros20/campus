...
function cerrar_prebasica(){
    ...
    $("#modal_prebasica").modal('hide');
    var iframe = document.getElementById('iframe_prebasica');
    iframe.src = iframe.src;

}
/*codigo para cerrar el modal y apagar el video al dar click en boton cerrar del modal*/
function cerrar_basica(){

     $("#modal_basica").modal('hide');
    var iframe = document.getElementById('iframe_basica');
    iframe.src = iframe.src;

}
/*codigo para cerrar el modal y apagar el video al dar click en boton cerrar del modal*/
function cerrar_media(){

     $("#modal_media").modal('hide');
    var iframe = document.getElementById('iframe_media');
    iframe.src = iframe.src;

}

function cerrar_polideportivo(){

     $("#modal_polideportivo").modal('hide');
     $('iframe').attr('src', $('iframe').attr('src'));
}

/*codigo para cerrar el modal y apagar el video al dar click en un area fuera del modal*/
$("#modal_prebasica").on('hidden.bs.modal', function () {
        var iframe = document.getElementById('iframe_prebasica');
        iframe.src = iframe.src;
    });
/*codigo para cerrar el modal y apagar el video al dar click en un area fuera del modal*/
$("#modal_basica").on('hidden.bs.modal', function () {
        var iframe = document.getElementById('iframe_basica');
        iframe.src = iframe.src;
    });
/*codigo para cerrar el modal y apagar el video al dar click en un area fuera del modal*/
